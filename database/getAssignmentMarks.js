...
const getAssignmentMarks = async (classID, assignmentID) => {
  try {
    ...
    const sqlText2 = `SELECT * FROM "public".${assignmentTable} FULL OUTER JOIN "public"."students" ON "public".${assignmentTable}."student" = "public"."students"."id" ORDER BY "lastname"`;
